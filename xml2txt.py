...
dirpath = r'D:\数据集\lt任务\口罩佩戴检测\数据集\v2.0\face-mask-detection\annotations'  # 原来存放xml文件的目录
newdir = r'D:\数据集\lt任务\口罩佩戴检测\数据集\v2.0\face-mask-detection\labels'                # 修改label后形成的txt目录
